function  editImg(objHandel,evt, x_lower, x_upper, y_lower, y_upper, edge_axes, EdgeImgPub, Imsg)
slider_x_lower = round(get(objHandel,'Value'));
...
set(x_lower, 'string', slider_x_lower)
