function  editImgXUpper(objHandel,evt, x_lower, x_upper, y_lower, y_upper, edge_axes, EdgeImgPub, Imsg)
slider_x_upper = round(get(objHandel,'Value'));
...
set(x_upper, 'string', slider_x_upper)
