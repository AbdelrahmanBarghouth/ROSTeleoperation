function  editImgYUpper(objHandel,evt, x_lower, x_upper, y_lower, y_upper, edge_axes, EdgeImgPub, Imsg)
slider_y_upper = 120+1-round(get(objHandel,'Value'));
...
set(y_upper, 'string', slider_y_upper)
...
% disp(size(tmpImg))
tmpImg2 = tmpImg(slider_x_lower:slider_x_upper, slider_y_upper:slider_y_lower);
% disp(size(tmpImg2))
